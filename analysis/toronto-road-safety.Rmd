...
```{r per-capita-metro, fig.height=4, fig.align="center", fig.cap="The trend line for each city is fit to the raw values with a simple least squared error method"}
