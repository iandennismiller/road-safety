...
The rate of pedestrian and cyclist fatalities per 100,000 residents are plotted in Figure \@ref(fig:per_capita_metro).

```{r per_capita_metro, fig.cap="The trend line for each city is fit to the raw values with a mean-squared error method"}
